...
/// Provides memory for QRVM stack.
class StackSpace
{
public:
    /// The maximum number of QRVM stack items.
...
public:
    ...
    ExecutionState(const qrvmc_message& message, qrvmc_revision revision,
    ...
    [[nodiscard]] bool in_static_mode() const { return (msg->flags & QRVMC_STATIC) != 0; }

    const qrvmc_tx_context& get_tx_context() noexcept
    {
